...
def settings_menu():
    ...
    while not settings_done:
        ...
        pygame.display.update()
        for event in pygame.event.get():  # Обработка событий во время настроек
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.KEYDOWN:
                            ...
                            if event.key == pygame.K_p:  # Pause
                                paused = True
                                while paused:
                                    for event in pygame.event.get():  # Обработка всех событий ввода во время паузы
                                        if event.type == pygame.KEYDOWN:
                                            if event.key == pygame.K_p:
                                                paused = False
                                            elif event.key == pygame.K_SPACE:  # Продолжить игру
                                                paused = False
                                            elif event.key == pygame.K_ESCAPE:  # Выйти из паузы
                                                paused = False
                                    screen.fill(bg)
                                    font = pygame.font.SysFont('comicsansms', 40)
                                    ...
                                    pygame.display.update()
                                    clock.tick(FPS)  # Уменьшает использование процессора
